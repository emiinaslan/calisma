 ...
 */
    ...
    public static void topla(int sayı1,int sayı2){
        System.out.println("int-int typ method çalıştı --> "+ (sayı1+sayı2));
    }
    public static void topla(double sayı1,int sayı2){
        System.out.println("double-int method çalıştı --> "+ (sayı1+sayı2));

    }
    public static void topla(int sayı1,double sayı2){
        System.out.println("int-double typ method çalıştı --> "+ (sayı1+sayı2));

    }
    public static void topla(double sayı1,double sayı2){
        System.out.println("double-double typ method çalıştı --> "+ (sayı1+sayı2));
