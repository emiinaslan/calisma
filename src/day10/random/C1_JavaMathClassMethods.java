...
public class C1_JavaMathClassMethods {
    public static void main(String[] args) {
        ...
        //random () methoduyla rastgele değer üretme
        double dbsayi = Math.random()*100;
        System.out.println("dbsayi = " + dbsayi);
        //int dfeğreler üretme
        int intsaı = (int) (Math.random()*50);
        System.out.println("intsaı = " + intsaı);
        int max=20;
        ...
        //java Math.Randm Class

        for (int i = 0; i <10 ; i++) {
            System.out.println((i+1)+ " . sayi "+ Math.random()*10        );

        }
        // Random Clas
        Random random = new Random();
        for (int i = 0; i <10 ; i++) {
            int randomsayı=random.nextInt(100);
            System.out.println("randomsayı = " + randomsayı);
