...
public class StringiTerstenYazdırna {
    public static void main(String[] args) {
        Scanner sc =new Scanner(System.in);
        System.out.println("tersine cevirmek istediğiniz String ifadeyi giriniz ");//ne ile Stringi tersine cevirmek istiyorsunuz
        String str= sc.nextLine();
sc.nextLine();
        System.out.println("ne ile Stringi tersine cevirmek istiyorsunuz\n ");//ne ile Stringi tersine cevirmek istiyorsunuz
        int secim= sc.nextInt();
StringiTersineÇevir(str,secim);
    ...
    public static void StringiTersineÇevir(String str,int secim){
        ...
        switch (secim){
            case 8 :
                method8ByteArray(str); break;
        }
        switch (secim){
            case 9 :
                method9ArrayList(str); break;
        }
        switch (secim){
            case 10 :
                method10Recursion(str); break;
        }
        switch (secim){
            case 11 :
                method11Stack(str); break;
        }
        switch (secim){
            case 12 :
                method12Lambda(str); break;
        }
        switch (secim){
            case 13 :
                method13UnicodeRLO(str); break;
        }
    }
