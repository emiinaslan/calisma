...
'                        LinkedHashset   : 1) Tekrarli eleman kabul e'mezler. Elemanlari ekleme sirasina(insertion order) gore dizerler.
...
'
    ...
    public static void main(String[] args) {
        ...
        HashSet<String>hs1=new HashSet<>();//bos bir hasset
        HashSet<String>hs2=new HashSet<>(Arrays.asList("Ercan","Yakup","Adem","Rukiye","Nur"));//bos bir hasset
        ...
        HashSet<String>hs3=new HashSet<>(Arrays.asList("Basarı","Gayrete","Asıktır"));
        System.out.println("hs3 = " + hs3);
        hs2.addAll(hs3);
        System.out.println("hs2 = " + hs2);

        System.out.println("hs2.remove(\"asıktır\") = " + hs2.remove("asıktır"));//false
        System.out.println("hs3.remove(\"Asıktır\") = " + hs3.remove("Asıktır"));//true
        System.out.println(hs3);//[Basarı, Gayrete]

        System.out.println("hs2.removeAll(hs3) = " + hs2.removeAll(hs3));
        System.out.println("hs2 = " + hs2);

        System.out.println("hs3.size() = " + hs3.size());
        System.out.println("hs3.isEmpty() = " + hs3.isEmpty());
        hs3.clear();
        System.out.println("hs3.isEmpty() = " + hs3.isEmpty());
        System.out.println("hs3.size() = " + hs3.size());
        System.out.println("hs3 = " + hs3);
        System.out.println("hs2.contains(\"Basarı\") = " + hs2.contains("Basarı"));
        System.out.println("hs2.contains(\"Asıktır\") = " + hs2.contains("Asıktır"));
